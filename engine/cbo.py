...
class CostBasedOptimizer:
    ...
    def optimize(self, root: PlanNode) -> CBOResult:
        ...
        # ── Collect table infos and join conditions ─────────────────────
    ...
    def _collect(
        ...
        if isinstance(node, ScanNode):
            ...
            # Pushed-down filter — associate it with the child source.
            self._collect(
                node.child, table_infos, join_conditions, pending_filter=node
            )
